...
public class MyLand extends javax.swing.JFrame {
    ...
    private void initComponents() {
		...
		*/
        ...
        getGraphicsConfiguration().getDevice().setDisplayMode(new DisplayMode(Toolkit.getDefaultToolkit().getScreenSize().width, Toolkit.getDefaultToolkit().getScreenSize().height, 16, DisplayMode.REFRESH_RATE_UNKNOWN));  
        repaint(); 
        */
